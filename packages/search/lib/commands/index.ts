...
export function pushSortByProperty(
...
export function pushSortByArguments(
  args: ValkeyCommandArguments,
  name: string,
...
export function pushArgumentsWithLength(
  args: ValkeyCommandArguments,
  fn: (args: ValkeyCommandArguments) => void
): ValkeyCommandArguments {
...
type CreateSchemaTextField = CreateSchemaCommonField<
...
type CreateSchemaNumericField =
  CreateSchemaCommonField<SchemaFieldTypes.NUMERIC>;

type CreateSchemaGeoField = CreateSchemaCommonField<SchemaFieldTypes.GEO>;

type CreateSchemaTagField = CreateSchemaCommonField<
...
type CreateSchemaFlatVectorField = CreateSchemaVectorField<
...
type CreateSchemaHNSWVectorField = CreateSchemaVectorField<
      ...
      case SchemaFieldTypes.VECTOR:
        ...
        pushArgumentsWithLength(args, () => {
          args.push(
            ...
            fieldOptions.TYPE,
            "DIM",
            fieldOptions.DIM.toString(),
            "DISTANCE_METRIC",
            fieldOptions.DISTANCE_METRIC
          );
          ...
          switch (fieldOptions.ALGORITHM) {
            ...
            case VectorAlgorithms.HNSW:
              ...
              if (fieldOptions.EF_CONSTRUCTION) {
                args.push(
                  "EF_CONSTRUCTION",
                  fieldOptions.EF_CONSTRUCTION.toString()
                );
              }
  ...
  if (options?.HIGHLIGHT) {
    ...
    if (typeof options.HIGHLIGHT === "object") {
      ...
      if (options.HIGHLIGHT.TAGS) {
        args.push(
          "TAGS",
          options.HIGHLIGHT.TAGS.open,
          options.HIGHLIGHT.TAGS.close
        );
      }
    }
  }
