...
export function pushRetentionArgument(
...
export function pushEncodingArgument(
  args: ValkeyCommandArguments,
...
export function pushChunkSizeArgument(
  args: ValkeyCommandArguments,
  chunkSize?: number
): ValkeyCommandArguments {
...
export function pushDuplicatePolicy(
  args: ValkeyCommandArguments,
  duplicatePolicy?: TimeSeriesDuplicatePolicies
): ValkeyCommandArguments {
...
export function pushLabelsArgument(
  args: ValkeyCommandArguments,
  labels?: Labels
): ValkeyCommandArguments {
  if (labels) {
...
export function pushMRangeGroupByArguments(
  args: ValkeyCommandArguments,
...
export function pushFilterArgument(
  args: ValkeyCommandArguments,
...
export function transformRangeReply(
  reply: Array<SampleRawReply>
): Array<SampleReply> {
  return reply.map(transformSampleReply);
}

type MRangeRawReply = Array<
  [key: string, labels: RawLabels, samples: Array<SampleRawReply>]
>;
...
export function transformMRangeReply(
  reply: MRangeRawReply
): Array<MRangeReplyItem> {
  const args = [];
...
export function transformMRangeWithLabelsReply(
  reply: MRangeRawReply
): Array<MRangeWithLabelsReplyItem> {
  const args = [];
...
export function pushLatestArgument(
  args: ValkeyCommandArguments,
  latest?: boolean
): ValkeyCommandArguments {
  if (latest) {
