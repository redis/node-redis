...
export function isAuthenticationResult(auth: AuthenticationResult | AccessToken): auth is AuthenticationResult {
  return (auth as AuthenticationResult).accessToken !== undefined;
}

export function isAccessToken(auth: AuthenticationResult | AccessToken): auth is AuthenticationResult {
  return (auth as AccessToken).token !== undefined;
}