...
describe("SEARCH", () => {
  describe("transformArguments", () => {
    it("without options", () => {
      assert.deepEqual(transformArguments("index", "query"), [
        "FT.SEARCH",
        "index",
        "query",
      ]);
    ...
    it("with SLOP", () => {
      assert.deepEqual(transformArguments("index", "query", { SLOP: 1 }), [
        "FT.SEARCH",
        "index",
        "query",
        "SLOP",
  ...
  describe("client.ft.search", () => {
    testUtils.testWithClient(
      ...
      async (client) => {
        ...
        assert.deepEqual(await client.ft.search("index", "*"), {
          total: 1,
          documents: [
            {
              id: "1",
