/** All members are currently down but failover attempts remain — the condition may clear (FR-013). */
...
/** All members are down and the configured `maxFailoverAttempts` are exhausted — the client has stopped retrying (FR-013). */
