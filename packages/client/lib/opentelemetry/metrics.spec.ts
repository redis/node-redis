...
describe("OTel Metrics Unit Tests", () => {
  ...
  it("should not record excluded commands", () => {
    ...
    const recordGET = OTelMetrics.createRecordOperationDuration(
      ["GET", "key"],
      {
        host: "localhost",
        port: "6379",
    ...
    const recordSET = OTelMetrics.createRecordOperationDuration(
      ["SET", "key"],
      {
        host: "localhost",
        port: "6379",
...
describe("OTel Metrics E2E", () => {
  ...
  it("should work with injected meter provider", async () => {
    ...
    OTelMetrics.recordConnectionCount(1);
    OTelMetrics.recordConnectionCount(2);
    OTelMetrics.recordConnectionCount(3);
  ...
  it("should use global meter provider from api.metrics", async () => {
    ...
    OTelMetrics.recordConnectionCount(5);
