...
| commandOptions         |         | Default [Command Options](./command-options.md) (e.g. `timeout`, `typeMapping`) for commands executed on the cluster                                                                                                                                |
| clientSideCache        |         | Client Side Caching configuration for the cluster (RESP3 only; shared across cluster nodes). See [V5 docs](./v5.md#client-side-caching)                                                                                                              |
