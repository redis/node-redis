...
| isolationPoolOptions         |                                          | An object that configures a pool of isolated connections. If you frequently need isolated connections, consider using [createClientPool](./pool.md#creating-a-pool) instead                                                                                                     |
...
However, if your use case requires exclusive connections, see [RedisClientPool](./pool.md), which allows you to create and manage multiple dedicated connections.
