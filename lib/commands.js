...
var addCommand = function (command) {
    ...
    if (!RedisClient.prototype[commandName]) {
        RedisClient.prototype[commandName.toUpperCase()] = RedisClient.prototype[commandName] = function () {
            var arr;
    ...
    // Do not override existing functions
    if (!Multi.prototype[commandName]) {
        Multi.prototype[commandName.toUpperCase()] = Multi.prototype[commandName] = function () {
            var arr;
            var len = arguments.length;
            var callback;
            var i = 0;
