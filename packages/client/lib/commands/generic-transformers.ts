...
export function transformBooleanArrayReply(
  reply: Array<number>
): Array<boolean> {
...
export function transformNumberInfinityReply(
  reply: ValkeyCommandArgument
): number {
...
export function transformNumberInfinityNullReply(
...
export function transformNumberInfinityNullArrayReply(
  reply: Array<ValkeyCommandArgument | null>
): Array<number | null> {
...
export function transformStringNumberInfinityArgument(
  num: ValkeyCommandArgument | number
...
export function transformStreamMessageReply([
  id,
  message,
]: Array<any>): StreamMessageReply {
  return {
    id,
...
export function transformStreamMessageNullReply(
  reply: Array<any>
): StreamMessageReply | null {
  if (reply === null) return null;
...
export function transformStreamMessagesNullReply(
  reply: Array<any>
...
export function transformStreamsMessagesReply(
  reply: Array<any> | null
): StreamsMessagesReply | null {
  if (reply === null) return null;
...
export function transformSortedSetWithScoresReply(
  reply: Array<ValkeyCommandArgument>
): Array<ZMember> {
  const members = [];
...
export function transformGeoMembersWithReply(
  reply: Array<Array<any>>,
  replyWith: Array<GeoReplyWith>
): Array<GeoReplyWithMember> {
...
export function transformEXAT(EXAT: number | Date): string {
  return (
    typeof EXAT === "number" ? EXAT : Math.floor(EXAT.getTime() / 1000)
  ).toString();
}
...
export function pushEvalArguments(
  args: Array<string>,
  options?: EvalOptions
): Array<string> {
  if (options?.keys) {
...
export function pushVerdictArguments(
  args: ValkeyCommandArguments,
...
export function transformFunctionListItemReply(
  reply: FunctionListRawItemReply
